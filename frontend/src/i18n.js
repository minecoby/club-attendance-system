const i18n = {
  ko: {
    ...
    save: '저장',
    saving: '저장 중...',
    locationSettingsSaved: '위치 설정이 저장되었습니다.',
    locationSettingsFailed: '위치 설정 저장 실패',
    currentLocationSet: '현재 위치가 설정되었습니다.',
    selectFromMap: '지도에서 선택',
    locationSelectedFromMap: '지도에서 위치가 선택되었습니다.',
  },
  en: {
    userInfo: 'User Info',
    userId: 'User ID',
    ...
    save: 'Save',
    saving: 'Saving...',
    locationSettingsSaved: 'Location settings saved.',
    locationSettingsFailed: 'Failed to save location settings.',
